...
<body>
    ...
    <form id='addvote' method="POST" action="index.php?d=hellovotes&c=votes&a=add_quest"> 
    <p>問卷名稱<input type="text" id='questionnaire' onBlur="" name="qName" >
    	幾個題目<input type="text" id='q_amount' onBlur="" name="qAmount" >
    ...
    <p><input type="submit" name="A1" value="新增問卷" onClick="check();">
